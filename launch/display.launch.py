...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'wheeled_humanoid_robot.urdf'
    xacro_file = "wheeled_humanoid_robot.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "wheeled_humanoid_robot"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("wheeled_humanoid_robot"), "rviz", "display_default.rviz"]
    )
    ...
    publish_robot_description = Node(
        package='wheeled_humanoid_robot',
